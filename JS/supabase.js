...
export async function syncFromSupabase() {
  ...
  try {
    const [courses, lectures, assignments, announcements] = await Promise.all([
      fetchTable("courses"),
      fetchTable("lectures"),
    ...
    console.log(`[supabase] Sync complete — ${courses.length} courses, ${lectures.length} lectures, ${assignments.length} assignments, ${announcements.length} announcements.`);
    return true;
  } catch (err) {
